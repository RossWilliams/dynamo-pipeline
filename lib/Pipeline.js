...
class Pipeline extends ScanQueryPipeline_1.ScanQueryPipeline {
    ...
    put(item, condition) {
        ...
        if (condition) {
            const compiledCondition = (0, helpers_1.conditionToDynamo)(condition);
    ...
    putIfNotExists(item) {
        const pkCondition = {
            ...
            property: (0, helpers_1.pkName)(this.config.keys),
        };
    ...
    buildUpdateRequest(key, attributes, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.condition) {
            const compiledCondition = (0, helpers_1.conditionToDynamo)(options.condition, {
                Condition: "",
                ...(Object.keys(expressionNames).length > 0 && {
                    ExpressionAttributeNames: expressionNames,
                }),
    ...
    delete(key, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.condition) {
            ...
            const compiledCondition = (0, helpers_1.conditionToDynamo)({
