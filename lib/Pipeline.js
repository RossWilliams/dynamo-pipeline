...
class Pipeline extends ScanQueryPipeline_1.ScanQueryPipeline {
    ...
    put(item, condition) {
        ...
        const promise = this.config.client.send(new lib_dynamodb_1.PutCommand(request));
        return promise
            .catch((e) => {
    ...
    update(key, attributes, options) {
        ...
        return this.config.client
            .send(new lib_dynamodb_1.UpdateCommand(request))
            .catch((e) => {
    ...
    delete(key, options) {
        ...
        return this.config.client
            .send(new lib_dynamodb_1.DeleteCommand(request))
            .catch((e) => {
