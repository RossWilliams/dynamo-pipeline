    ...
    buildQueryScanRequest(options) {
        ...
        const request = {
            ...
            ...(options.keyConditions && {
                KeyConditionExpression: "#p0 = :v0" + (skValue ? ` AND ${(0, helpers_1.skQueryToDynamoString)(skValue)}` : ""),
            }),
        ...
        if (options.filters) {
            const compiledCondition = (0, helpers_1.conditionToDynamo)(options.filters, keySubstitues);
