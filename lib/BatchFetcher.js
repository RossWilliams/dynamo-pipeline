...
class BatchGetFetcher extends AbstractFetcher_1.AbstractFetcher {
    ...
    fetchStrategy() {
        ...
        if (this.operation === "transactGet") {
            ...
            promise = this.documentClient.send(new lib_dynamodb_1.TransactGetCommand(transactionRequest));
        }
            ...
            promise = this.documentClient.send(new lib_dynamodb_1.BatchGetCommand(batchGetRequest));
        }
